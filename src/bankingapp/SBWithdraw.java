 ...
 * @author  s
 */
public class SBWithdraw extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(bankingapp.BankingApp.class).getContext().getResourceMap(SBWithdraw.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(bankingapp.BankingApp.class).getContext().getActionMap(SBWithdraw.class, this);
    ...
    public void makeWithdraw() {
        try {
            ...
            if (Double.parseDouble(amountText.getText()) > Utils.getSBAccountBalance(((Accounts) accountsCombo.getSelectedItem()).getId())) {
            ...
            ledgerHead = ((LedgerHeads) Utils.getLedgerHead("SB Interest")).getId();
            ...
            if (resp == JOptionPane.YES_OPTION) {
                ...
                String[] p1 = {"SB Interest", amountText.getText().trim()};
                PrintDemon.getInstance().payments.add(p1);
            }
        } catch (PropertyVetoException ex) {
            Logger.getLogger(SBWithdraw.class.getName()).log(Level.SEVERE, null, ex);
