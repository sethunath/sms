...
import bankingapp.MdsPayments;
import bankingapp.Members;
import bankingapp.LedgerHeads;
import bankingapp.UserMds;
...
public class MDSInstallments extends javax.swing.JInternalFrame {
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        String displayMdsNameSql = "select mds.name from user_mds left join accounts on accounts.id = user_mds.accounts_id inner join mds on user_mds.mds_id = mds.id where accounts.id = " + a.getId();
        System.out.println(displayMdsNameSql);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String remarks =""+mdsNameLabel.getText()+"(#"+installmentText.getText()+")";
        ...
        if (fromSuspense) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, e.getMessage()+"--"+e.toString(), "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
        try {
            this.setClosed(true);
