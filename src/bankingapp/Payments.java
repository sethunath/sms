...
public class Payments extends javax.swing.JInternalFrame {
    ...
    public Payments(int mno) { //to select the item
        initComponents();
        BankingPUEntityManager = javax.persistence.Persistence.createEntityManagerFactory("BankingAppPU").createEntityManager();
        LedgerHeads lh= Utils.getLedgerHead("Admission Fee");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(bankingapp.BankingApp.class).getContext().getResourceMap(Payments.class);
        setTitle(resourceMap.getString("Form.title")); // NOI18N
        setName("Form"); // NOI18N

        criteriaCombo.setFont(resourceMap.getFont("jLabel2.font")); // NOI18N
        ...
        debitRadio.setFont(resourceMap.getFont("jLabel2.font")); // NOI18N
        debitRadio.setText(resourceMap.getString("debitRadio.text")); // NOI18N
        debitRadio.setName("debitRadio"); // NOI18N

        creditRadio.setFont(resourceMap.getFont("jLabel2.font")); // NOI18N
        ...
        jComboBox1.setFont(resourceMap.getFont("jLabel2.font")); // NOI18N
        ...
        remarksText.setText(resourceMap.getString("remarksText.text")); // NOI18N
        remarksText.setName("remarksText"); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(remarksText, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE))
                                .addGap(50, 50, 50)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if (resp == JOptionPane.YES_OPTION) {
                String[] p = {jComboBox1.getSelectedItem().toString(), amountText.getText().trim()};
