 ...
 */
public class ReportAssetLiabilityProfitLoss extends javax.swing.JInternalFrame {


    private EntityManager BankingPUEntityManager;

    /** Creates new form ReportGeneralLedger */
    public ReportAssetLiabilityProfitLoss() {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setMaximizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(bankingapp.BankingApp.class).getContext().getResourceMap(ReportAssetLiabilityProfitLoss.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(bankingapp.BankingApp.class).getContext().getActionMap(ReportAssetLiabilityProfitLoss.class, this);
        ...
        org.jdesktop.swingbinding.JComboBoxBinding jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, headTypesList, catCombo);
    ...
    private void catComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_catComboActionPerformed
        // TODO add your handling code here:
        HeadTypes ht = (HeadTypes) catCombo.getSelectedItem();
