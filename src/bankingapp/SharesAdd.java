 ...
 * @author  s
 */
public class SharesAdd extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (resp == JOptionPane.YES_OPTION) {
                String[] p = {"Shares", amoutText.getText().trim()};
    ...
    private void pkTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pkTextActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pkTextActionPerformed
    ...
    private void populateNumberOfShares(Members m) {
        try {
            ...
            if(md.getShares().equals("")){
                presentSharesText.setText("0");
            }
        } catch (Exception e) {
            presentSharesText.setText("0");
        }
